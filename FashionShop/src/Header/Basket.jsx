...
const handlerClick = (e) => {
    e.target.closest(".conteiner").classList.remove("show");
};
...
// Рендер товаров в корзине 
    ...
    return(
        ...
        <div className="cart-wrapper">
            { (props.signal === true) ? (<div className="goods">
        ...
        </div>) : (<div id='cart-empty'>Ваша корзина пока пуста!</div>)}
        </div>

        <button className=" btn-primary cart-confirm">Оформить заказ</button>
