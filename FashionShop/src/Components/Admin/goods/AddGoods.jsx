            ...
            <TableBody>
              <TableRow>
                <TableCell className={classes.header}>
                  <span className="chart-header">add product</span>
                  <Button
                    variant="contained"
                    color="secondary"
        ...
        <Paper>
          <Table>
            <TableBody>
              <TableRow>
                <TableCell className={classes.header}>
                  <span className="chart-header">add new category</span>
                  <Button
                    variant="contained"
...
const mapStateToProps = state => {
  return {
    ...
    categories: state.AddGoodsReducer.categories,
    newGood: state.AddGoodsReducer.newGood
  };
};
const mapDispatchToProps = dispatch => {
  return bindActionCreators(
    {
      uploadImg: payload => {
        return { type: 'UPLOAD_IMG', payload: payload };
      },
      alert: payload => {
        return { type: 'WARNING_ALERT', payload: payload };
      },
      addCategory: payload => {
        return { type: 'ADD_CATEGORY', payload: payload };
      },
      creatGood: payload => {
        return { type: 'CREAT_GOOD', payload: payload };
      },
      addGood: payload => {
        return { type: 'ADD_GOOD', payload: payload };
      }
    },
    dispatch
  );
